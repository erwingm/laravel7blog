...
<head>
    ...
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="{{asset('frontend/css/theme-3.css')}}">
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark" >
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				<div class="profile-section pt-3 pt-lg-0">
				    <img class="profile-image mb-3 rounded-circle mx-auto" src="{{asset('frontend/images/profile.png')}}" alt="image" >			
